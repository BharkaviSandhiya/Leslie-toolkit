...
const CapitalHotTub = () => {
  ...
  return (
    <div className="capitalHot-container">
      <div className="sidebar">
        <Sidebar/>
      </div>
      <div className="content">
        <div className="horizontal-container">
          <div className="capitalbrand-container">
            <div>
              <h1> Brand - Capital Hot Tub</h1>
            </div>
            <div className="btn-modal">
              <CSVLink data={csvData} filename={`${brand.toLowerCase().replace(/\s+/g, '-')}-Capital.csv`}>
                <box-icon 
                  type='solid' 
                  name='cloud-download' 
                  color='#000' 
