    ...
    <div className="splash-container">
      ...
      <div className="content">
        <div className="horizontal-container">
          <div className="splashbrand-container">
            <div>
              <h1> Brand - Splash Pool And Spa</h1>
            </div>
            <div className="btn-modal">
              <CSVLink data={csvData} filename={`${brand.toLowerCase().replace(/\s+/g, '-')}-splash.csv`}>
                <box-icon 
                  type='solid' 
                  name='cloud-download' 
                  color='#000' 
