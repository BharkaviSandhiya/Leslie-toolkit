...
const PoolCity = () => {
  ...
  return (
    <div className="poolCityBrand-container">
      <div className="sidebar">
        <Sidebar/>
      </div>
      <div className="content">
        <div className="horizontal-container">
          <div className="poolcity-container">
            <div>
              <h1> Brand - Pool City</h1>
            </div>
            <div className="btn-modal">
              <CSVLink data={csvData} filename={`${brand.toLowerCase().replace(/\s+/g, '-')}-pool-city.csv`}>
                <box-icon 
                  type='solid' 
                  name='cloud-download' 
                  color='#000' 
