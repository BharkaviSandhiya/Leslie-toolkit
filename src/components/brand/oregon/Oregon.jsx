...
const Oregon = () => {
  ...
  return (
    <div className="oregonBrand-container">
      ...
      <div className="content">
        <div className="horizontal-container">
          <div className="oregonbrand-container">
            <div>
              <h1> Brand - Oregon Hot Tub</h1>
            </div>
            <div className="btn-modal">
              <CSVLink data={csvData} filename={`${brand.toLowerCase().replace(/\s+/g, '-')}-oregon.csv`}>
                <box-icon 
                  type='solid' 
                  name='cloud-download' 
                  color='#000' 
